            ...
            <div className={'row'}>
              ...
              <div className='col-sm-4	col-md-4	col-lg-4	col-xl-4' >
                <div className={'row' + " " + styles.btncentermobview}>
                  ...
                  <Link href="/register">
                    <Button className={styles.signupbtn + " " + styles.btnbgcolor} value="Sign up" >Sign up</Button>
                  </Link>
                </div>
                <div className={'row' + " " + styles.ownerbtncentermobview}>
                  <Link href="/registerowner">
                    <Button className={styles.signupbtn + " " + styles.btnbgnone} value="Sign up" >Sign up as Owner</Button>
                  </Link>
                </div>
              </div>
